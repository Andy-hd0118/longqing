...
function calculatePetYield() {
    ...
    if (mode === 'rental') {
        // 出租模式：收益率 = 出租收益灵石 / 金杯兑换灵石 × 金杯单价 / 宠物价格
        ...
        formula = `${rentalIncome} ÷ ${goldCupExchange} × ${goldCupPrice} ÷ ${petPrice}`;
        paybackDays = 1 / yieldRate;
        
    } else if (mode === 'convoy') {
        // 发车模式：收益率 = 每天发车灵石收益 / 金杯兑换灵石 × 金杯单价 / 宠物价格
        ...
        formula = `${convoyIncome} ÷ ${goldCupExchange} × ${goldCupPrice} ÷ ${petPrice}`;
        paybackDays = 1 / yieldRate;
        
    } else if (mode === 'pvp') {
        // PVP模式：收益率 = 掉落金杯数 × 金杯价格 / 宠物价格
        ...
        formula = `${pvpCups} × ${goldCupPrice} ÷ ${petPrice}`;
